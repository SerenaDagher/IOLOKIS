...
const Circle = forwardRef(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center bg-black p-1 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export function TechMap({ isMobile}) {
          ...
          <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between gap-10">
              <div className="flex flex-row items-center justify-between relative">
                  <div className="absolute left-0 -translate-x-full ">
                      {!isMobile && (
                          <p className="text-end me-5 hidden lg:flex">
                              Patients Insights
                          </p>
                      )}
                  </div>
                  ...
                  <div className="absolute right-0 translate-x-full pl-5">
                      {!isMobile && (
                          <p className="text-end me-5 hidden lg:flex">
                              Ask AI Anything
                          </p>
                  ...
                  <Circle ref={div5Ref}>
                      ...
                      {/* {!isMobile && <p className="font-normal">Ask AI Anything</p>} */}
                  </Circle>
              </div>
              <div className="flex flex-row items-center justify-between relative">
                    <div className="absolute left-0 -translate-x-full ">
                  ...
                  <div
                      ref={div4Ref}
                      className="size-16 z-10 flex size-12 items-center justify-center bg-black p-1 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]"
                  >
                      <img
                          src="logo.svg"
                          alt="icon for feature item"
