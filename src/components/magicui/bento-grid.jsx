...
const BentoGrid = ({
  ...
  return (
    (<div
      className={cn("grid w-full h-full pb-8 ps-6 pe-6 auto-rows-[22rem] grid-cols-3 gap-8", className)}
      {...props}>
      {children}
    </div>)
  );
...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // light styles
      "bg-zinc-900 [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]",
      // dark styles
